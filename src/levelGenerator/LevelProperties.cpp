...
{
	obstiAni=	{getAnimator({0,1,2,1},{20,20,20,20}),getAnimator({3,4,5,4},{20,20,20,20}),getAnimator({6},{0}),
				getAnimator({7},{0}),getAnimator({8},{0}),getAnimator({9},{0}),
				getAnimator({10},{0}),getAnimator({11},{0}),getAnimator({12},{0}),
				getAnimator({13},{0}),getAnimator({14},{0}),getAnimator({15},{0})};
